...
public partial class Contexts : Entitas.IContexts {
    ...
    public GameInputContext gameInput { get; set; }
    public GameplayContext gameplay { get; set; }
    public GameSettingsContext gameSettings { get; set; }

    public Entitas.IContext[] allContexts { get { return new Entitas.IContext [] { gameflow, gameInput, gameplay, gameSettings }; } }

    public Contexts() {
        gameflow = new GameflowContext();
        gameInput = new GameInputContext();
...
public partial class Contexts {
    ...
    public void InitializeContextObservers() {
        try {
            ...
            CreateContextObserver(gameInput);
            CreateContextObserver(gameplay);
            CreateContextObserver(gameSettings);
